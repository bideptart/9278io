  ...
  return (
    <main className="flex min-h-dvh flex-col bg-background text-foreground">
        ...
        <div className="grid w-full items-stretch gap-10 px-6 pb-6 pt-3 md:px-8 md:pb-8 md:pt-4 lg:grid-cols-[1.1fr_0.9fr] lg:gap-8">
          <div className="min-w-0">
            <ScrollReveal>
              ...
              <p className="mt-4 max-w-full break-words text-pretty text-base leading-relaxed text-muted-foreground sm:max-w-3xl md:text-lg">
      ...
      <section className="border-b border-border/50">
        <div className="flex w-full items-center justify-center px-6 py-10 md:px-8 md:py-14">
