  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          'focus-visible:border-ring focus-visible:ring-ring/50 flex flex-1 items-center gap-3 px-6 pt-5 pb-5 data-[state=open]:pb-0 text-left text-base font-semibold transition-all outline-none hover:text-primary focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&>svg]:transition-transform [&>svg]:duration-200 [&[data-state=open]>svg]:rotate-90',
          className,
        )}
        {...props}
      >
        <ChevronRightIcon className="pointer-events-none size-3.5 shrink-0" />
        {children}
      </AccordionPrimitive.Trigger>
