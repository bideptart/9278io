...
export function Hero() {
  ...
  return (
    <section className="overflow-hidden border-b border-border bg-slate-900">
      {/* Subtle grid overlay */}
      ...
      {/* Top glow */}
      <div aria-hidden className="pointer-events-none absolute -top-32 left-1/3 h-80 w-80 rounded-full bg-primary/20 blur-[100px]" />

      <div className="relative mx-auto flex w-full max-w-7xl flex-col gap-12 px-6 py-16 md:py-20 lg:flex-row lg:items-center lg:gap-16 lg:py-24">
        ...
        <div className="flex-1">
          ...
          <motion.h1
            ...
            className="max-w-xl text-balance text-4xl font-bold leading-[1.1] tracking-tight text-white sm:text-5xl md:text-6xl"
          >
          ...
          >
            <Button
              asChild
              size="lg"
              className="h-12 rounded-xl bg-primary px-7 text-sm font-semibold text-white shadow-[0_4px_24px_oklch(0.52_0.22_265/0.5)] hover:bg-primary/90"
            >
          ...
          <motion.div
            ...
            className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-2 xl:grid-cols-4"
          >
            {stats.map((s) => (
            ...
            <div key={key}>
              ...
              <div className="space-y-2.5">
                {transcript.map((line, i) => (
                  ...
                  >
                    {line.speaker === "Agent" ? (
                      <span className="max-w-[82%] rounded-xl bg-primary/[0.2] px-3 py-2 text-primary ring-1 ring-primary/25">
                        <span className="mr-1.5 text-[10px] font-bold opacity-60">Agent</span>
                        {line.text}
                      </span>
                    ) : (
                      <span className="max-w-[82%] rounded-xl bg-white/[0.1] px-3 py-2 text-white/80 ring-1 ring-white/10">
