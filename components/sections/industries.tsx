...
const industries = [
  {
    ...
    script: [
      { speaker: "Agent", text: "Rahul ji, aapki EMI kal due hai." },
      { speaker: "Caller", text: "Haan, main kal pay kar dunga." },
    ],
  ...
  },
  {
    ...
    script: [
      { speaker: "Agent", text: "Sir, aap 2BHK flat mein interested hain?" },
      { speaker: "Caller", text: "Yes, Pune mein dekhna tha." },
    ],
  ...
  },
  {
    ...
    script: [
      { speaker: "Agent", text: "Your appointment is tomorrow at 10 AM." },
      { speaker: "Caller", text: "Can I reschedule to 2 PM?" },
    ],
  ...
  },
  {
    ...
    script: [
      { speaker: "Agent", text: "Priya, have you enrolled for NEET batch?" },
      { speaker: "Caller", text: "Not yet, tell me about the fees." },
    ],
  ...
  },
  {
    ...
    script: [
      { speaker: "Agent", text: "Your order is out for delivery today!" },
      { speaker: "Caller", text: "Great, what time will it arrive?" },
    ],
  ...
  },
  {
    ...
    script: [
      { speaker: "Agent", text: "Sir, your car service is due this week." },
      { speaker: "Caller", text: "Book Saturday 11 AM please." },
    ],
  ...
  },
  {
    ...
    description: "Table reservations, delivery status, and feedback calls for restaurant chains — handled over Jio and Airtel lines.",
    caps: ["Inbound", "24/7 Calling", "Appointment"],
    script: [
      { speaker: "Agent", text: "Welcome to Spice Garden! Table for how many?" },
      { speaker: "Caller", text: "4 people, 8 PM tonight." },
    ],
  ...
  },
  {
    ...
    caps: ["Inbound", "Appointment", "DPDP Ready"],
    script: [
      { speaker: "Agent", text: "Hello, I can schedule a free consultation." },
      { speaker: "Caller", text: "Yes, tomorrow afternoon works." },
    ],
    href: "/industries/legal",
  },
  {
