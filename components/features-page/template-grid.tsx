...
const TEMPLATES = [
  {
    ...
    tags: ["Appointment booking", "Call transfer", "Caller lookup"],
    tone: "#2563EB",
  },
  {
    icon: HeartPulse,
    ...
    tags: ["Reminders", "Patient intake", "Follow-up calls"],
    tone: "#EF4444",
  },
  {
    icon: Truck,
    ...
    tags: ["Live status", "Dispatch routing", "Booking confirmation"],
    tone: "#D97706",
  },
  {
    icon: Headset,
    ...
    tags: ["Ticket creation", "FAQ answers", "Human escalation"],
    tone: "#7C3AED",
  },
  {
    icon: FileText,
    ...
    tags: ["No preset script", "Full customization", "Build from scratch"],
    tone: "#64748B",
  },
]
      ...
      <div className="relative mt-6 overflow-hidden rounded-2xl border border-border/60 bg-white shadow-[0_1px_2px_rgba(15,23,42,0.04)]">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="grid gap-6 p-6 md:grid-cols-[auto_1fr] md:p-8"
          >
            ...
            <div className="min-w-0">
              ...
              <div className="flex items-start gap-2.5 rounded-xl border border-border/60 bg-[#F8FAFC] px-4 py-3">
                <PhoneIncoming className="mt-0.5 size-4 shrink-0" style={{ color: current.tone }} aria-hidden />
                <p className="text-sm italic leading-relaxed text-foreground/80">&ldquo;{current.greeting}&rdquo;</p>
              </div>
