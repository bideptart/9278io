 ...
 * pulsing bell hub with four notification-channel cards (email, SMS, push,
 * and the meeting-booked event) radiating out on animated dashed paths,
 * plus three decorative floating channel-icon bubbles and corner dot grids.
 * The whole 520x440 canvas keeps its original pixel-coordinate layout and
 * scales down as a single block on narrow screens instead of hiding cards
 * below `sm`, so every element stays visible at any width.
 */
