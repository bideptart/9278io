    ...
    <main className="min-h-dvh bg-white text-slate-900">
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: industry.name, path: "/industries/bpo" },
        ]}
      />
      <ServiceJsonLd
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-2 lg:gap-16">
          <ScrollReveal>
            ...
            <div className="mt-9 flex flex-wrap gap-3.5">
              ...
              >
                <Link href="/get-started?industry=bpo">
          ...
          <ScrollReveal delay={0.12}>
            <div className="relative mx-auto w-full max-w-[400px]">
              <div className="relative aspect-square w-full overflow-hidden rounded-[2rem] border border-slate-200/70 bg-white shadow-[0_30px_70px_-25px_rgba(37,99,235,0.35)]">
                <Image
                  src="/images/bpo-rollout.png"
                  alt="How BPO & call centres teams roll out 9278.io — agents, launch, and analytics workflow"
                  fill
