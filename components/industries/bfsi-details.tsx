...
// Topic icons mapped by position — matches the fixed BFSI content order
// (lead qualify, EMI reminder, policy renewal, KYC, compliance).
const JOB_ICONS = [Landmark, Bell, ShieldCheck, ClipboardCheck, ShieldCheck]
const SAMPLE_ICONS = [Bell, Landmark, ShieldCheck]
          ...
          <div className="relative h-full overflow-hidden rounded-[2rem] border border-slate-200/70 bg-gradient-to-b from-blue-50/40 to-white p-6 shadow-sm md:p-8">
            ...
            <ul className="relative mt-8 space-y-3">
              {industry.jobs.map((job, i) => {
                const Icon = JOB_ICONS[i] ?? Landmark
                return (
                  <li
                    key={job}
